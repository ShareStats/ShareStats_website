## All in one table
setwd('/Users/tasospsy/Google Drive/Software_projects/ShareStats/itembank/')
...
setwd('/Users/tasospsy/Google Drive/Software_projects/ShareStats/q-sharestats/data/')
