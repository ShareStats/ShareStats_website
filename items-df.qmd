...
get_link <- function(what, folder, name){
  ...
  link <- switch(what,
                 ...
                 wooclap = paste0(packages_link, 'wooclap/', folder, '-wooclap.xml'),
  ...
  mutate(Files = paste0(
    '<div class="dropdown mt-3">
      ...
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
        ...
        <li><a class="dropdown-item" href="',get_link("qti", folder, name),'">QTI</a></li>
        ...
        <li><a class="dropdown-item" href="',get_link("wooclap", folder, name),'">Wooclap</a></li>
      </ul>
    </div>'
  )) %>% 
