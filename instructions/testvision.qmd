...
It is also possible to download the **ZIP Folder** with all the raw files from the [itembank search page](items-df.qmd). When you unpack the zip you will have a folder containing the item `.Rmd` file, and date or image files.
