...
<iframe width="560" height="315" src="https://www.youtube.com/embed/31OItmHCxrA?si=d3V8z8qO16UQMC2Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
For compiling the items to a Canvas ZIP you can use the `exams2canvas` function from the exams package. Make sure to first install the exams package to R if you do not have it installed already.
