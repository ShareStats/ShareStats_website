...
description: Instructional video on how to use the R exams package to create exam question packages
---
...
It is also possible to download the **ZIP Folder** with all the raw files from the [itembank search page](https://www.sharestats.nl/items-df.html). When you unpack the zip you will have a folder containing the item `.Rmd` file, and date or image files.
